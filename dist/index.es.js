...
var Ct = /*#__PURE__*/ Y(bt, [["render", St]]), wt = { class: "ui-form-item" }, Tt = {
	...
	key: 0,
	class: "ui-input-prefix"
}, Ht = { class: "ui-input-suffix" }, Ut = /* @__PURE__ */ u({
	__name: "Select",
	props: {
	...
	setup(e, { emit: t }) {
		let u = e, d = t, f = r(() => {
			...
			return i;
		}), p = B(f, d), g = r(() => u.data.map((e) => typeof e == "string" || typeof e == "number" ? {
			value: String(e),
			label: String(e)
		} : {
			...e,
